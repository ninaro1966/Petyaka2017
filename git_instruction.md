...
показывает все наши версиии, измененные в git c указанием кода изменений, удобно пользоваться git log --oneline, git log --al --oneline, где еще и видно в ветке ли master мы находимся