...
git branch <название ветки>
 ...
 позволяет преключаться из ветки в ветку, причем между словами "branch" и <название ветки> есть только пробел. Если после созданной ветки нет коммита, то нечему будет разветвляться
...
причем без подчеркивания и угловых скобок при именовании ветки
